...
const cardMathType: CardInfo = {
  ...
  techIcons: ['TypeScript.svg', 'JavaScript.svg', 'React.svg', 'HTML5.svg', 'CSS3.svg'],
...
const cardPorfolio: CardInfo = {
  ...
  longDescription: 'Take a look at the source code of this web portfolio. It has been developed using Next.js 13 along with TypeScript.',
